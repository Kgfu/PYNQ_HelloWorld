...
extern "C" void colordetect_accel(char*, char*, __cosim_sC__*, int, int, __cosim_sC__*, int, int, int, volatile void *);
extern "C" void apatb_colordetect_accel_hw(volatile void * __xlx_apatb_param_src, volatile void * __xlx_apatb_param_low_thresh, volatile void * __xlx_apatb_param_high_thresh, volatile void * __xlx_apatb_param_dst, int __xlx_apatb_param_rows, int __xlx_apatb_param_cols, int __xlx_apatb_param_t1, volatile void * __xlx_apatb_param_t2) {
  ...
  // DUT call
  colordetect_accel(__xlx_low_thresh__input_buffer, __xlx_high_thresh__input_buffer, __xlx_src_input_buffer, __xlx_offset_byte_param_low_thresh, __xlx_offset_byte_param_high_thresh, __xlx_dst_input_buffer, __xlx_apatb_param_rows, __xlx_apatb_param_cols, __xlx_apatb_param_t1, __xlx_apatb_param_t2);
