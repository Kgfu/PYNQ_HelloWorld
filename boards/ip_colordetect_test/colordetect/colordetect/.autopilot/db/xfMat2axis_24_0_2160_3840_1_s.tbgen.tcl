set moduleName xfMat2axis_24_0_2160_3840_1_s
set isTopModule 0
...
set C_modelName {xfMat2axis<24, 0, 2160, 3840, 1>}
set C_modelType { void 0 }
set C_modelArgList {
	{ imgHelper1_437 int 8 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "imgHelper1_437", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ imgHelper1_437_dout sc_in sc_lv 8 signal 0 } 
	{ imgHelper1_437_empty_n sc_in sc_logic 1 signal 0 } 
	{ imgHelper1_437_read sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "imgHelper1_437_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "imgHelper1_437", "role": "dout" }} , 
 	{ "name": "imgHelper1_437_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "imgHelper1_437", "role": "empty_n" }} , 
 	{ "name": "imgHelper1_437_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "imgHelper1_437", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"Port" : [
			{"Name" : "imgHelper1_437", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "imgHelper1_437_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "img_rows", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "5", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "img_rows_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "img_cols", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "5", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	imgHelper1_437 { ap_fifo {  { imgHelper1_437_dout fifo_data 0 8 }  { imgHelper1_437_empty_n fifo_status 0 1 }  { imgHelper1_437_read fifo_update 1 1 } } }
...
set C_modelType { void 0 }
set C_modelArgList {
	{ imgOutput_4105 int 8 regular {fifo 0 volatile }  }
	{ img_rows int 32 regular {fifo 0}  }
	{ img_cols int 32 regular {fifo 0}  }
	{ dst_V_data_V int 24 regular {axi_s 1 volatile  { dst Data } }  }
	{ dst_V_keep_V int 3 regular {axi_s 1 volatile  { dst Keep } }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "imgOutput_4105", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "img_rows", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "img_cols", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "dst_V_data_V", "interface" : "axis", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "dst_V_keep_V", "interface" : "axis", "bitwidth" : 3, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ ap_idle sc_out sc_logic 1 done -1 } 
	{ ap_ready sc_out sc_logic 1 ready -1 } 
	{ imgOutput_4105_dout sc_in sc_lv 8 signal 0 } 
	{ imgOutput_4105_empty_n sc_in sc_logic 1 signal 0 } 
	{ imgOutput_4105_read sc_out sc_logic 1 signal 0 } 
	{ img_rows_dout sc_in sc_lv 32 signal 1 } 
	{ img_rows_empty_n sc_in sc_logic 1 signal 1 } 
	{ img_rows_read sc_out sc_logic 1 signal 1 } 
	{ img_cols_dout sc_in sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ap_idle", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "done", "bundle":{"name": "ap_idle", "role": "default" }} , 
 	{ "name": "ap_ready", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "ready", "bundle":{"name": "ap_ready", "role": "default" }} , 
 	{ "name": "imgOutput_4105_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "imgOutput_4105", "role": "dout" }} , 
 	{ "name": "imgOutput_4105_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "imgOutput_4105", "role": "empty_n" }} , 
 	{ "name": "imgOutput_4105_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "imgOutput_4105", "role": "read" }} , 
 	{ "name": "img_rows_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "img_rows", "role": "dout" }} , 
 	{ "name": "img_rows_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_rows", "role": "empty_n" }} , 
 	{ "name": "img_rows_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_rows", "role": "read" }} , 
 	{ "name": "img_cols_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "img_cols", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"HasNonBlockingOperation" : "0",
		"Port" : [
			{"Name" : "imgOutput_4105", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "imgOutput_4105_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "img_rows", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "9", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "img_rows_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "img_cols", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "9", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "img_cols_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "dst_V_data_V", "Type" : "Axis", "Direction" : "O",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	imgOutput_4105 { ap_fifo {  { imgOutput_4105_dout fifo_data 0 8 }  { imgOutput_4105_empty_n fifo_status 0 1 }  { imgOutput_4105_read fifo_update 1 1 } } }
	img_rows { ap_fifo {  { img_rows_dout fifo_data 0 32 }  { img_rows_empty_n fifo_status 0 1 }  { img_rows_read fifo_update 1 1 } } }
	img_cols { ap_fifo {  { img_cols_dout fifo_data 0 32 }  { img_cols_empty_n fifo_status 0 1 }  { img_cols_read fifo_update 1 1 } } }
	dst_V_data_V { axis {  { dst_TDATA out_data 1 24 } } }
	dst_V_keep_V { axis {  { dst_TKEEP out_data 1 3 } } }
