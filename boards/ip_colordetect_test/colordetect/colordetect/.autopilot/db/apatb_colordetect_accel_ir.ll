; ModuleID = '/home/willychiang/Desktop/PYNQ-HelloWorld/boards/ip/colordetect/colordetect/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_colordetect_accel_ir(%"class.hls::stream"* %src, i8* %low_thresh, i8* %high_thresh, %"class.hls::stream"* %dst, i32 %rows, i32 %cols, i32 %t1, i32* %t2) local_unnamed_addr #1 {
entry:
  %src_copy = alloca %"class.hls::stream", align 512
  %low_thresh_copy = alloca [9 x i8], align 512
  %high_thresh_copy = alloca [9 x i8], align 512
  %dst_copy = alloca %"class.hls::stream", align 512
  %t2_copy = alloca i32, align 512
  %0 = bitcast i8* %low_thresh to [9 x i8]*
  %1 = bitcast i8* %high_thresh to [9 x i8]*
  call fastcc void @copy_in(%"class.hls::stream"* %src, %"class.hls::stream"* nonnull align 512 %src_copy, [9 x i8]* %0, [9 x i8]* nonnull align 512 %low_thresh_copy, [9 x i8]* %1, [9 x i8]* nonnull align 512 %high_thresh_copy, %"class.hls::stream"* %dst, %"class.hls::stream"* nonnull align 512 %dst_copy, i32* %t2, i32* nonnull align 512 %t2_copy)
  %2 = getelementptr inbounds [9 x i8], [9 x i8]* %low_thresh_copy, i32 0, i32 0
  %3 = getelementptr inbounds [9 x i8], [9 x i8]* %high_thresh_copy, i32 0, i32 0
  call void @apatb_colordetect_accel_hw(%"class.hls::stream"* %src_copy, i8* %2, i8* %3, %"class.hls::stream"* %dst_copy, i32 %rows, i32 %cols, i32 %t1, i32* %t2_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %src, %"class.hls::stream"* nonnull align 512 %src_copy, [9 x i8]* %0, [9 x i8]* nonnull align 512 %low_thresh_copy, [9 x i8]* %1, [9 x i8]* nonnull align 512 %high_thresh_copy, %"class.hls::stream"* %dst, %"class.hls::stream"* nonnull align 512 %dst_copy, i32* %t2, i32* nonnull align 512 %t2_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, [9 x i8]* readonly, [9 x i8]* noalias align 512, [9 x i8]* readonly, [9 x i8]* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, i32* readonly, i32* noalias align 512) unnamed_addr #2 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream"(%"class.hls::stream"* align 512 %1, %"class.hls::stream"* %0)
  call fastcc void @onebyonecpy_hls.p0a9i8([9 x i8]* align 512 %3, [9 x i8]* %2)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a9i8([9 x i8]* noalias align 512, [9 x i8]* noalias readonly) unnamed_addr #5 {
entry:
...
for.loop:                                         ; preds = %for.loop, %copy
  ...
  %dst.addr = getelementptr [9 x i8], [9 x i8]* %0, i64 0, i64 %for.loop.idx1
  %src.addr = getelementptr [9 x i8], [9 x i8]* %1, i64 0, i64 %for.loop.idx1
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, [9 x i8]*, [9 x i8]* noalias readonly align 512, [9 x i8]*, [9 x i8]* noalias readonly align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512, i32*, i32* noalias readonly align 512) unnamed_addr #6 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream"(%"class.hls::stream"* %0, %"class.hls::stream"* align 512 %1)
  call fastcc void @onebyonecpy_hls.p0a9i8([9 x i8]* %2, [9 x i8]* align 512 %3)
...
declare void @apatb_colordetect_accel_hw(%"class.hls::stream"*, i8*, i8*, %"class.hls::stream"*, i32, i32, i32, i32*)

define void @colordetect_accel_hw_stub_wrapper(%"class.hls::stream"*, i8*, i8*, %"class.hls::stream"*, i32, i32, i32, i32*) #7 {
entry:
  %8 = bitcast i8* %1 to [9 x i8]*
  %9 = bitcast i8* %2 to [9 x i8]*
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, [9 x i8]* null, [9 x i8]* %8, [9 x i8]* null, [9 x i8]* %9, %"class.hls::stream"* null, %"class.hls::stream"* %3, i32* null, i32* %7)
  %10 = bitcast [9 x i8]* %8 to i8*
  %11 = bitcast [9 x i8]* %9 to i8*
  call void @colordetect_accel_hw_stub(%"class.hls::stream"* %0, i8* %10, i8* %11, %"class.hls::stream"* %3, i32 %4, i32 %5, i32 %6, i32* %7)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, [9 x i8]* null, [9 x i8]* %8, [9 x i8]* null, [9 x i8]* %9, %"class.hls::stream"* null, %"class.hls::stream"* %3, i32* null, i32* %7)
  ret void
}

declare void @colordetect_accel_hw_stub(%"class.hls::stream"*, i8*, i8*, %"class.hls::stream"*, i32, i32, i32, i32*)
