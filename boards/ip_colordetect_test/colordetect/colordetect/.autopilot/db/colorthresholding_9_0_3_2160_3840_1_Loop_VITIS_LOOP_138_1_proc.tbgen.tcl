set moduleName colorthresholding_9_0_3_2160_3840_1_Loop_VITIS_LOOP_138_1_proc
set isTopModule 0
...
set C_modelName {colorthresholding<9, 0, 3, 2160, 3840, 1>_Loop_VITIS_LOOP_138_1_proc}
...
set portList { 
	...
	{ high_thresh_dout sc_in sc_lv 64 signal 2 } 
	{ high_thresh_empty_n sc_in sc_logic 1 signal 2 } 
	{ high_thresh_read sc_out sc_logic 1 signal 2 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.low_r_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.high_r_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	low_thresh { ap_memory {  { low_thresh_address0 mem_address 1 4 }  { low_thresh_ce0 mem_ce 1 1 }  { low_thresh_q0 mem_dout 0 8 } } }
	high_thresh { ap_memory {  { high_thresh_address0 mem_address 1 4 }  { high_thresh_ce0 mem_ce 1 1 }  { high_thresh_q0 mem_dout 0 8 } } }
}
set moduleName colorthresholding_9_0_3_2160_3840_1_Loop_VITIS_LOOP_138_1_proc
set isTopModule 0
set isCombinational 0
