...
set Library     "hls"
set IPName      "colordetect_accel"
set Version     "1.0"
set DisplayName "colordetect_accel"
set Revision    "2112389356"
set Description "Image Color Detection IP"
set Device      "zynq"
set AutoFamily  ""
...
set xo_kernel_name "colordetect_accel"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/willychiang/Desktop/PYNQ-HelloWorld/boards/ip/colordetect/colordetect"
set debug_dir "/home/willychiang/Desktop/PYNQ-HelloWorld/boards/ip/colordetect/colordetect/.debug"
set xo_hls_files_dir ""
set hdl_module_list {colordetect_accel_regslice_both
...
colordetect_accel_fifo_w16_d2_S
colordetect_accel_fifo_w16_d2_S
colordetect_accel_fifo_w8_d3_S
colordetect_accel_fifo_w8_d3_S
colordetect_accel_fifo_w8_d3_S
colordetect_accel_fifo_w8_d3_S
colordetect_accel_fifo_w8_d3_S
...
colordetect_accel_fifo_w16_d2_S
colordetect_accel_fifo_w16_d2_S
colordetect_accel_start_for_colorthresholding_9_0_3_2160_3840_1_Block_colorthresholding_9_0_3_2dEe
...
colordetect_accel_regslice_both
colordetect_accel_regslice_both
colordetect_accel_fifo_w64_d2_S
colordetect_accel_fifo_w64_d2_S
colordetect_accel_fifo_w32_d2_S
colordetect_accel_fifo_w32_d2_S
colordetect_accel_fifo_w32_d3_S
colordetect_accel_fifo_w32_d2_S
colordetect_accel_fifo_w32_d2_S
colordetect_accel_fifo_w32_d4_S
colordetect_accel_fifo_w32_d4_S
colordetect_accel_fifo_w32_d5_S
colordetect_accel_fifo_w32_d5_S
colordetect_accel_fifo_w32_d6_S
colordetect_accel_fifo_w32_d6_S
colordetect_accel_fifo_w32_d7_S
colordetect_accel_fifo_w32_d7_S
colordetect_accel_fifo_w32_d8_S
colordetect_accel_fifo_w32_d8_S
colordetect_accel_fifo_w32_d9_S
colordetect_accel_fifo_w32_d9_S
colordetect_accel_fifo_w24_d2_S
colordetect_accel_fifo_w32_d2_S
colordetect_accel_fifo_w32_d2_S
colordetect_accel_fifo_w24_d2_S
colordetect_accel_fifo_w8_d2_S
colordetect_accel_fifo_w8_d2_S
colordetect_accel_fifo_w8_d2_S
colordetect_accel_fifo_w8_d2_S
colordetect_accel_fifo_w8_d2_S
colordetect_accel_start_for_Block_ZN2xf2cv3MatILi9ELi2160ELi3840ELi1ELi2EEC2Eii_exit2_proc_U0
colordetect_accel_start_for_axis2xfMat_24_9_2160_3840_1_U0
colordetect_accel_start_for_erode_0_0_2160_3840_0_3_3_1_1_25_U0
colordetect_accel_start_for_dilate_0_0_2160_3840_0_3_3_1_1_26_U0
colordetect_accel_start_for_dilate_0_0_2160_3840_0_3_3_1_1_U0
colordetect_accel_start_for_erode_0_0_2160_3840_0_3_3_1_1_U0
colordetect_accel_start_for_xfMat2axis_24_0_2160_3840_1_U0
colordetect_accel_start_for_bgr2hsv_9_2160_3840_1_U0
...
## Variables
set Top "colordetect_accel"
set TopNoPrefix "colordetect_accel"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 low_thresh_1 W 0x0 "Data signal of low_thresh" {{0 32 low_thresh W 0 "Bit 31 to 0 of low_thresh"}}} {0x14 low_thresh_2 W 0x0 "Data signal of low_thresh" {{0 32 low_thresh W 0 "Bit 63 to 32 of low_thresh"}}} {0x1c high_thresh_1 W 0x0 "Data signal of high_thresh" {{0 32 high_thresh W 0 "Bit 31 to 0 of high_thresh"}}} {0x20 high_thresh_2 W 0x0 "Data signal of high_thresh" {{0 32 high_thresh W 0 "Bit 63 to 32 of high_thresh"}}} {0x28 rows W 0x0 "Data signal of rows" {{0 32 rows W 0 "Bit 31 to 0 of rows"}}} {0x30 cols W 0x0 "Data signal of cols" {{0 32 cols W 0 "Bit 31 to 0 of cols"}}} {0x38 t1 W 0x0 "Data signal of t1" {{0 32 t1 W 0 "Bit 31 to 0 of t1"}}} {0x40 t2 R 0x0 "Data signal of t2" {{0 32 t2 R 0 "Bit 31 to 0 of t2"}}} {0x44 t2_ctrl R 0x0 "Control signal of t2" {{0 1 t2_ap_vld R 0 "Control signal t2_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem0 m_axi_gmem1 src dst"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
