...
extern "C" void colordetect_accel_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, int, int);
...
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_low_thresh)[j];
  ...
  tcl_file.set_num(9, &tcl_file.low_thresh_depth);
...
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_high_thresh)[j];
  ...
  tcl_file.set_num(9, &tcl_file.high_thresh_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_high_thresh, __xlx_sprintf_buffer.data());
}
...
colordetect_accel_hw_stub_wrapper(__xlx_apatb_param_src, __xlx_apatb_param_low_thresh, __xlx_apatb_param_high_thresh, __xlx_apatb_param_dst, __xlx_apatb_param_rows, __xlx_apatb_param_cols);
