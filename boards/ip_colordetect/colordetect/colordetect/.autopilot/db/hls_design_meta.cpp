...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("dst_TDATA", 24, hls_out, 9, "axis", "out_data", 1),
	Port_Property("dst_TKEEP", 3, hls_out, 10, "axis", "out_data", 1),
	Port_Property("dst_TSTRB", 3, hls_out, 11, "axis", "out_data", 1),
	Port_Property("dst_TUSER", 1, hls_out, 12, "axis", "out_data", 1),
	Port_Property("dst_TLAST", 1, hls_out, 13, "axis", "out_data", 1),
	Port_Property("dst_TID", 1, hls_out, 14, "axis", "out_data", 1),
	Port_Property("dst_TDEST", 1, hls_out, 15, "axis", "out_data", 1),
	Port_Property("src_TVALID", 1, hls_in, 6, "axis", "in_vld", 1),
	Port_Property("src_TREADY", 1, hls_out, 6, "axis", "in_acc", 1),
	Port_Property("dst_TVALID", 1, hls_out, 15, "axis", "out_vld", 1),
	Port_Property("dst_TREADY", 1, hls_in, 15, "axis", "out_acc", 1),
};
