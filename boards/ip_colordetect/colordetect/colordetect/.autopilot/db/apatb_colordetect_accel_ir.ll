...
define void @apatb_colordetect_accel_ir(%"class.hls::stream"* %src, i8* %low_thresh, i8* %high_thresh, %"class.hls::stream"* %dst, i32 %rows, i32 %cols) local_unnamed_addr #1 {
entry:
  ...
  call fastcc void @copy_in(%"class.hls::stream"* %src, %"class.hls::stream"* nonnull align 512 %src_copy, [9 x i8]* %0, [9 x i8]* nonnull align 512 %low_thresh_copy, [9 x i8]* %1, [9 x i8]* nonnull align 512 %high_thresh_copy, %"class.hls::stream"* %dst, %"class.hls::stream"* nonnull align 512 %dst_copy)
  ...
  call void @apatb_colordetect_accel_hw(%"class.hls::stream"* %src_copy, i8* %2, i8* %3, %"class.hls::stream"* %dst_copy, i32 %rows, i32 %cols)
  call fastcc void @copy_out(%"class.hls::stream"* %src, %"class.hls::stream"* nonnull align 512 %src_copy, [9 x i8]* %0, [9 x i8]* nonnull align 512 %low_thresh_copy, [9 x i8]* %1, [9 x i8]* nonnull align 512 %high_thresh_copy, %"class.hls::stream"* %dst, %"class.hls::stream"* nonnull align 512 %dst_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, [9 x i8]* readonly, [9 x i8]* noalias align 512, [9 x i8]* readonly, [9 x i8]* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #2 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, [9 x i8]*, [9 x i8]* noalias readonly align 512, [9 x i8]*, [9 x i8]* noalias readonly align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #6 {
entry:
...
declare void @apatb_colordetect_accel_hw(%"class.hls::stream"*, i8*, i8*, %"class.hls::stream"*, i32, i32)

define void @colordetect_accel_hw_stub_wrapper(%"class.hls::stream"*, i8*, i8*, %"class.hls::stream"*, i32, i32) #7 {
entry:
  %6 = bitcast i8* %1 to [9 x i8]*
  %7 = bitcast i8* %2 to [9 x i8]*
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, [9 x i8]* null, [9 x i8]* %6, [9 x i8]* null, [9 x i8]* %7, %"class.hls::stream"* null, %"class.hls::stream"* %3)
  %8 = bitcast [9 x i8]* %6 to i8*
  %9 = bitcast [9 x i8]* %7 to i8*
  call void @colordetect_accel_hw_stub(%"class.hls::stream"* %0, i8* %8, i8* %9, %"class.hls::stream"* %3, i32 %4, i32 %5)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, [9 x i8]* null, [9 x i8]* %6, [9 x i8]* null, [9 x i8]* %7, %"class.hls::stream"* null, %"class.hls::stream"* %3)
  ret void
}

declare void @colordetect_accel_hw_stub(%"class.hls::stream"*, i8*, i8*, %"class.hls::stream"*, i32, i32)
