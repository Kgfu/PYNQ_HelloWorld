...
module colordetect_accel_axis2xfMat_24_9_2160_3840_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
output   start_out;
output   start_write;
output  [23:0] imgInput_499_din;
input   imgInput_499_full_n;
output   imgInput_499_write;
...
reg   [0:0] icmp_ln82_reg_209;
reg    src_TDATA_blk_n;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] icmp_ln82_fu_176_p2;
reg    img_rows_blk_n;
reg    img_cols_blk_n;
...
reg   [11:0] i_2_reg_195;
wire    ap_CS_fsm_state2;
wire   [0:0] icmp_ln80_fu_161_p2;
wire   [11:0] j_2_fu_166_p2;
...
wire   [31:0] zext_ln80_fu_157_p1;
wire   [31:0] zext_ln82_fu_172_p1;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln80_fu_161_p2 == 1'd0))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state3))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln80_fu_161_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((~((img_cols_out_full_n == 1'b0) | (img_rows_out_full_n == 1'b0) | (img_cols_empty_n == 1'b0) | (img_rows_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_reg_129 <= 12'd0;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln82_fu_176_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln82_fu_176_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((icmp_ln82_fu_176_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln80_fu_161_p2 == 1'd0))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln82_reg_209 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln82_reg_209 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        imgInput_499_write = 1'b1;
    end else begin
        imgInput_499_write = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln82_fu_176_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((icmp_ln82_fu_176_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((icmp_ln82_fu_176_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln82_fu_176_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (src_TVALID_int_regslice == 1'b0)) | ((icmp_ln82_reg_209 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (imgInput_499_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln82_fu_176_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (src_TVALID_int_regslice == 1'b0)) | ((icmp_ln82_reg_209 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (imgInput_499_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln82_fu_176_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (src_TVALID_int_regslice == 1'b0)) | ((icmp_ln82_reg_209 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (imgInput_499_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_state1 = ((img_cols_out_full_n == 1'b0) | (img_rows_out_full_n == 1'b0) | (img_cols_empty_n == 1'b0) | (img_rows_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (real_start == 1'b0));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter0 = ((icmp_ln82_fu_176_p2 == 1'd1) & (src_TVALID_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((icmp_ln82_reg_209 == 1'd1) & (imgInput_499_full_n == 1'b0));
end
...
assign i_2_fu_151_p2 = (i_reg_129 + 12'd1);

assign icmp_ln80_fu_161_p2 = (($signed(zext_ln80_fu_157_p1) < $signed(rows_reg_185)) ? 1'b1 : 1'b0);

assign icmp_ln82_fu_176_p2 = (($signed(zext_ln82_fu_172_p1) < $signed(cols_reg_190)) ? 1'b1 : 1'b0);

assign imgInput_499_din = axi_data_V_reg_213;

assign img_cols_out_din = img_cols_dout;

assign img_rows_out_din = img_rows_dout;

assign j_2_fu_166_p2 = (j_reg_140 + 12'd1);

assign src_TREADY = regslice_both_AXI_video_strm_V_data_V_U_ack_in;

assign start_out = real_start;

assign zext_ln80_fu_157_p1 = i_reg_129;

assign zext_ln82_fu_172_p1 = j_reg_140;

endmodule //colordetect_accel_axis2xfMat_24_9_2160_3840_1_s
