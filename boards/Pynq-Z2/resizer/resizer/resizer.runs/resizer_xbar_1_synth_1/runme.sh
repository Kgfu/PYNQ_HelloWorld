...
HD_PWD='/home/willychiang/Desktop/PYNQ-HelloWorld/boards/Pynq-Z2/resizer/resizer/resizer.runs/resizer_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log resizer_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source resizer_xbar_1.tcl
