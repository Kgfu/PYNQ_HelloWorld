...
# <./colordetect/colordetect.xpr> in the current working folder.

set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
   create_project colordetect colordetect -part xc7z020clg400-1
}
...
xilinx.com:hls:colordetect_accel:1.0\
...
proc create_root_design { parentCell } {
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs colordetect_accel_0/s_axi_control/Reg] SEG_colordetect_accel_0_Reg
